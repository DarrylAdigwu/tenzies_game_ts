# Tenzies Game
Vist site: https://darryls-tenzies-game.vercel.app/

A fun roll of the dice game, where your goal is to match the numbers on each "die". Have fun and enjoy.
...
## Overview
Built with: TypeScript, React, React-confetti, and nanoid